...
const { createValidatorsBody, createValidatorsParams } = require('../services/cashFlow/validators');

router.post('/', createValidatorsBody, cashFlowController.create);
router.put('/:id_flow_cash', createValidatorsBody, cashFlowController.update);
